...
if __name__ == "__main__":
    ...
    #         "mongodb+srv://dylan:DylanBee23@cluster0.a4ejgtt.mongodb.net/?retryWrites=true&w=majority")
    # except:
    #     cluster = pymongo.MongoClient(
    #         "mongodb://:@ac-hpnfpjp-shard-00-00.a4ejgtt.mongodb.net:27017,ac-hpnfpjp-shard-00-01.a4ejgtt.mongodb.net:27017,ac-hpnfpjp-shard-00-02.a4ejgtt.mongodb.net:27017/?ssl=true&replicaSet=atlas-a94cse-shard-0&authSource=admin&retryWrites=true&w=majority")
    # db = cluster["user"]
